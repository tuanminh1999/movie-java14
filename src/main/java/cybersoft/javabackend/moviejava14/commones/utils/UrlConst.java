package cybersoft.javabackend.moviejava14.commones.utils;
...
public class UrlConst {
	...
	// CumRap
	public static final String URL_CUM_RAP_CONTROLLER = "/api/quanLyCumRap";
	public static final String GET_CUM_RAP =  "/LayDanhSachCumRap";
